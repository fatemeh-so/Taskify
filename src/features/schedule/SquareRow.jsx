...
function SquareRow({ task }) {
  ...
  const priorityColorChip = priorityColorsChip[task?.priority] || 'gray' // Default color is "gray" if priority is not recognized
  ...
  return (
    <div className='p-4 overflow-x-hidden bg-white rounded-lg shadow-md mb-4 hover:shadow-lg transition-shadow duration-300 ease-in-out'>
      <div className='flex flex-col sm:flex-row sm:justify-between sm:items-center mb-4'>
        <div
          className='font-bold text-lg sm:text-xl text-gray-800 mb-2 sm:mb-0'
      ...
      <div className='border p-4 rounded-lg bg-gray-50'>
        ...
        <div className='text-gray-700'>
          {task?.description?.map((desc, index) => (
            <div key={index} className='flex justify-start mt- mb-2'>
...
//   return (
//     <div className='p-4 overflow-x-hidden bg-yellow-100 rounded-lg shadow-md mb-4 hover:shadow-lg transition-shadow duration-300 ease-in-out'>
//       <div className='flex flex-col sm:flex-row sm:justify-between sm:items-center mb-4'>
//         <div
//           className='font-bold text-lg sm:text-xl text-gray-800 mb-2 sm:mb-0'
//           style={{ overflowWrap: 'break-word', wordBreak: 'break-word' }}
